...
>
> GPU data created by the get-nvidia-data.py script is structured in key value pairs for performance. Desktop and notebook GPUs are separated to account for the same GPU name in both a desktop and notebook series (e.g. GeForce GTX 10 Series GPUs, such as the GeForce GTX 1050 Ti). OS data is structured more traditionally, since both the code and part of the name must be compared.
>
> - GPU data:
>	- GPU name and `pfid`
>
